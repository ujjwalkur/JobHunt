            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4 mt-4 md:mt-0">
                        <a href="https://x.com/im_ujjwall" target="_blank" className="hover:text-gray-400" aria-label="Twitter">
                        ...
                        <a href="https://www.linkedin.com/in/ujjwal-singh2211/" target="_blank" className="hover:text-gray-400" aria-label="LinkedIn">
                ...
                <div className="items-center flex flex-col font-medium">
                    <h3>Developer By: <span className='text-[#F83002]'>Ujjwal Kumar</span></h3>
                </div>
            </div>
